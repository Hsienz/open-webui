<script>
	...
	import Containers from './Settings/Containers.svelte';
	...
	>
		...
		<button
			...
			'containers'
				...
				: ' text-gray-300 dark:text-gray-600 hover:text-gray-700 dark:hover:text-white'}"
			on:click={() => {
				goto('/admin/settings/containers');
			}}
		>
			<div class=" self-center mr-2">
				<svg
